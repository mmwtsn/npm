...
exports.recalculateMetadata = safe.recurseLimit(100, 10000, function (tree, log, $$recurse$$, next) {
  ...
  chain([
    ...
    [asyncMap, tree.children, function (child, done) { $$recurse$$(child, log, done) }]
  ], function () {
...
exports.loadExtraneous = safe.recurseLimit(100, 1000, function (tree, log, $$recurse$$, next) {
  validate('OOFF', arguments)
